    ...
    >
      ...
      <View style={{ paddingHorizontal: wp('4%') }}>
        ...
        <View style={styles.detailContain}>
          ...
          <Text
            style={[styles.prodPrice, { color: theme.dark ? '#fff' : '#000' }]}
          >
            {product.price}
          </Text>
          <View style={styles.ratingContain}>
            ...
            <Text
              style={[styles.reviews, { color: theme.dark ? '#777' : '#ccc' }]}
            >
        ...
        >
          ...
          <Text
            style={[styles.countTxt, { color: theme.dark ? '#000' : '#fff' }]}
          >
            {count}
          </Text>
          <TouchableOpacity
        ...
        <View style={styles.btnContain}>
          ...
          >
            <Text
              style={[styles.cartTxt, { color: theme.dark ? '#fff' : '#000' }]}
            >
              Add to cart
            </Text>
          </TouchableOpacity>
