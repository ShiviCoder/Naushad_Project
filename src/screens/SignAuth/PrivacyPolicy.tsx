    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <Text style={[styles.text, { color: theme.textSecondary }]}>
          ...
          safeguard your data while using our application.
        </Text>
        ...
        <Text style={[styles.text, { color: theme.textSecondary }]}>
          ...
          and usage data to improve our services and provide a better user
          experience.
        </Text>
        ...
        <Text style={[styles.text, { color: theme.textSecondary }]}>
          ...
          customer support, and improve the app's functionality. We do not share
        ...
        <Text style={[styles.text, { color: theme.textSecondary }]}>
          ...
          communicated through the app, and continued use signifies your
