...
const BookingPackageScreen = ({ navigation }) => {
  ...
  const handleProceed = () => {
    ...
    navigation.navigate('PackagePayementScreen', {
  ...
  const renderService = service => {
    ...
    return (
      ...
      >
        <Image
          source={{
            uri: service.imageUrl || '../../../../assets/placeholder.jpg',
          }}
          style={styles.serviceImage}
          defaultSource={require('../../../../assets/placeholder.jpg')}
          onError={() =>
            console.log('Image loading error for:', service.serviceName)
          }
          onLoad={() =>
  ...
  return (
    ...
    >
      ...
      {services.length > 0 && (
        ...
        >
          <Text style={[styles.proceedButtonText, { color: '#fff' }]}>
            Proceed to Pay
          </Text>
        </TouchableOpacity>
      )}
...
export default BookingPackageScreen;
