...
const BookAppoinementFundAdd = ({ navigation, route }) => {
  ...
  const initiatePayment = async () => {
    ...
    try {
      ...
      // Show success popup first, then navigate to PaymentScreen
      showPopup('Funds added successfully! Redirecting...', 'success');

      setTimeout(() => {
        navigation.navigate('PaymentScreen', {
          ...route.params,
          from: 'BookAppoinementFundAdd',
          addedAmount: amount,
...
// styles same as your FundAddScreen
...
export default BookAppoinementFundAdd;
